...
- **[privacy_policy.md](user/privacy_policy.md)** - Privacy practices and data collection
...
- **[legal.md](legal/legal.md)** - Data sources, attribution, and IP compliance
- **[legal_compliance_summary.md](legal/legal_compliance_summary.md)** - Quick compliance overview
- **[legal_compliance_final_status.md](legal/legal_compliance_final_status.md)** - Detailed compliance report
- **[compliance_review.md](legal/compliance_review.md)** - Item-by-item compliance checklist
- **[summary_legal_compliance_review.md](legal/summary_legal_compliance_review.md)** - Executive summary
...
- **[font_optimization.md](fonts/font_optimization.md)** - Mana font optimization guide
- **[beleren_font.md](fonts/beleren_font.md)** - Beleren font integration
- **[mplantin_font.md](fonts/mplantin_font.md)** - MPlantin font integration
- **[deployment_beleren.md](fonts/deployment_beleren.md)** - Beleren deployment guide
...
- **[scryfall_syntax_analysis.md](technical/scryfall_syntax_analysis.md)** - Search syntax documentation
- **[scryfall_data.md](technical/scryfall_data.md)** - Data structure reference
- **[export_import.md](technical/export_import.md)** - Data export/import procedures
- **[missing_cards.md](technical/missing_cards.md)** - Missing card tracking

### Other Directories

- **[changelog/](changelog/)** - Version history and feature updates
- **[sample_data/](sample_data/)** - Sample card data for reference

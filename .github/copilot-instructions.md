...
- **Format HTML**: `npx oxfmt api/static/app.js api/static/index.html` -- takes ~2 seconds.
...
- **BEFORE committing**: Run `npx oxfmt` to format the HTML/JS frontend.
...
npx oxfmt                            # Format HTML/JS (~2 seconds)
...
├── package.json             # Node.js dependencies (oxfmt)

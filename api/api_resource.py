...
# existed, plus image_cluster_id (display-only placeholder cluster, needed by both renderers).
# Order/membership must match DEFAULT_FIELDS in card_engine/src/lib.rs.
...
class APIResource:
    ...
    def placeholders_v1_css(self, *, falcon_response: falcon.Response | None = None, **_: object) -> None:
        """Return the placeholders-v1.css file (blurred card placeholder images as data URIs).
